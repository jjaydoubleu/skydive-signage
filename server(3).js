...
function buildPage(msg) {
  ...
  if (type === 'idle') {
    ...
    var thirdcamCross  = msg.thirdcam ? '' : '<div style="position:absolute; top:50%; left:50%; transform:translate(-50%,-60%); font-size:60px; color:#e53e3e; font-weight:bold; line-height:1; opacity:0.85;">&#x2715;</div>';
    cameraHtml += '<div style="display:table-cell; padding:0 10px;">'
