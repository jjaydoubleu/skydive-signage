...
function activateAudio() {
  ...
  tryPlay();
  // Start refreshing now that we're activated
  startRefresh(buildRefreshUrl(true, lastFp));
}
...
function tryPlay() {
  ...
  if (msgFp !== lastFp && msgType !== 'idle' && audioMap[msgType]) {
    ...
    a.play().catch(function(e) {
      ...
      startRefresh(buildRefreshUrl(true, msgFp));
    });
    a.onended = function() {
      startRefresh(buildRefreshUrl(true, msgFp));
    };
