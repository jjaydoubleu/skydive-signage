...
#activate h1 { font-size: 36px; color: #ffffff; margin-bottom: 16px; }
#activate p  { font-size: 20px; color: #888; }
</style>
</head>
<body>
<div id="activate" onclick="activateAudio()" style="display:none;">
...
(function() {
  try {
    var activated = false;
    try { activated = sessionStorage.getItem('audioActivated') === '1'; } catch(e) {}
...
function activateAudio() {
  try { sessionStorage.setItem('audioActivated', '1'); } catch(e) {}
